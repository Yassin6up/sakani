...
const FilterPlace = () => {
    ...
    const placesFilter = [
        ...
        } ,
       {
          ...
          coordinate : {
            lat : 32.3487546307592 ,
            long : 35.7624829184763
          }, 
          places : [
            {
              name : t('Ajloun Governorate') , 
        ...
        } ,
      {
          ...
          coordinate : {
            lat : 31.6377780080039 ,
            long : 35.7845620439348
          }, 
          places : [
            {
        ...
        } ,
        {
          ...
          coordinate : {
            lat :  32.5219282822206 ,
            long : 35.8744861915841
          }, 
          places : [
            {
        ...
        } ,
       {
          ...
          coordinate : {
            lat : 32.2603160683486 ,
            long : 35.8581541785671
          }, 
          places : [
            {
...
const dispatch = useDispatch()
      ...
      function removeQuotes(array) {
        return array.map(item => {
          // Remove quotes from the main name property
          item.name = item.name.replace(/"t\(([^)]+)\)"/g, "t($1)");
      
          // Remove quotes from each place's name property
    ...
    console.log("url :",apiUrl)
      try {
          // Save the full API link to secure store
          ...
          // Handle the response, e.g., navigate to another screen, update state, etc.
        ...
        return (
            <ScrollView contentContainerStyle={styles.container}>
                ...
                {filteredPlaces.map((place) => (
                    <TouchableOpacity key={place.name} onPress={() =>  {
